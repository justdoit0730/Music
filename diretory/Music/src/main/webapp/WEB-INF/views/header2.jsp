...
<div class="rd-navbar-collapse">
	<ul class="socialite-list">
		<li><a class="icon novi-icon socialite fas fa-user-plus"
			href="#" data-toggle="modal" data-target="#join" data-whatever="@fat"></a></li>
		<li><a class="icon novi-icon socialite fas fa-user" href="#"
			data-toggle="modal" data-target="#login" data-whatever="@mdo"></a></li>
		<li><a class="icon novi-icon   socialite fa-facebook"
			class="btn btn-primary  dropdown-toggle" data-toggle="dropdown"
			href="#"></a>
			<div class="dropdown-menu">
				<a class="dropdown-item" href="#">한준희</a> <a
					class="dropdown-item" href="#">372</a> <a class="dropdown-item"
					href="#">안경잽이</a> <a class="dropdown-item" href="#">SSip</a>
			</div></li>
		<li><a class="icon novi-icon socialite fa-twitter"
			class="btn btn-primary  dropdown-toggle" data-toggle="dropdown"
			href="#"></a>
			<div class="dropdown-menu">
				<a class="dropdown-item" href="#">Link 1</a> <a
					class="dropdown-item" href="#">Link 2</a> <a class="dropdown-item"
					href="#">Link 3</a> <a class="dropdown-item" href="#">Link 3</a>
			</div></li>
			...
			<div class="modal-content">
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control"
								style="width: 60%; float: left; margin-right: 30px; margin-bottom: 10px"
								id="recipient-name" placeholder="E-mail"> <input
								type="button" onclick="sample2_execDaumPostcode()"
								value="인증번호 발송" class="form-control"
								style="width: 30%; margin-bottom: 10px"> <input
								type="text" class="form-control" id="recipient-name"
								style="width: 60%; float: left; margin-right: 30px;"
								placeholder="인증번호"> <input type="button"
								onclick="sample2_execDaumPostcode()" value="인증번호  확인"
						...
						<div id="layer"
							...
							<img src="//t1.daumcdn.net/postcode/resource/images/close.png"
								...
								onclick="closeDaumPostcode()" alt="닫기">
						</div>
						...
						<div class="form-group" style="display: flex;">
											...
											<input type="button" onclick="sample2_execDaumPostcode()"
												value="우편번호 입력" class="form-control" style="width: 300px;"><br>
										</div>
										<div class="form-group" style="margin-bottom: -9px;"  >
											<label for="address1" style="display:none;"></label> <input type="text"
												id="sample2_address" name="address" placeholder="주소" readonly
						...
						<div class="form-group" style="width: 300px;">
							<input type="text" id="address1" name="o_addr"				class="form-control" placeholder="상세주소">
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-toggle="modal"
						data-target="#join2" data-whatever="@fat">Member Join</button>
				</div>
			</div>
		</div>
	</div>
	<div class="modal fade" id="join2" tabindex="-1" role="dialog"
		aria-labelledby="join2" aria-hidden="true">
		<div class="modal-dialog" role="document" style="color: #000;">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">22222</label>
							<input type="text" class="form-control" id="recipient-name">
						</div>
						<div class="form-group">
